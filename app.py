...
opcion = st.sidebar.radio(
    ...
    ["📊 Panel de control general", "📋 Gestión de JIRAs", "💽 Entorno de desarrollo FinIQ", "💽 Entorno de testeo FinIQ"],
...
elif opcion == "💽 Entorno de desarrollo FinIQ":
    st.title("💽 Entorno de desarrollo FinIQ")

    import streamlit.components.v1 as components

    st.markdown("### 🌐 Acceso al entorno de desarrollo")
    st.caption("Inicia sesión con tus credenciales habituales de FinIQ.")

    components.iframe(
        "https://finiqbondsdev.finiq-connect.com/FinIQAPIGateway/Account/LoggedOut",
        height=850,
        scrolling=True
    )

    st.write("---")
    st.caption("¿Problemas de acceso? Prueba a abrir directamente en el navegador:")
    st.link_button(
        "🔗 Abrir FinIQ Dev en nueva pestaña",
        "https://finiqbondsdev.finiq-connect.com/FinIQAPIGateway/Account/LoggedOut"
    )

elif opcion == "💽 Entorno de testeo FinIQ":
